	...
	<head>
		...
		<style type="text/css">
			*{margin:0;padding:0;}
			...
			.tz_content .t_header .h_nav ul li a .h_icon8{background-position:-152px 0;}
			.tz_content .t_header .h_nav ul li a:hover .h_icon8{background-position:-152px -25px;}
			...
			.tz_content .t_right .r_location .l_welcome{width:100%;height:51px;position:absolute;top:0;background:#ffcc99;color:#fff;text-indent:20px;font-size:14px;box-shadow:0px 0px 5px #000;}
			.tz_content .t_right .r_location .l_welcome .close{display:block;width:20px;height:20px;background:#ffffcc;border:1px solid #ffcc99;border-radius:50%;text-align:center;line-height:20px;float:right;text-indent:0;margin:14px 20px 0 0;display:none;}
			.tz_content .t_right .r_location .l_welcome:hover{background:rgba(255,204,153,.8);}
			.tz_content .t_right .r_location .l_welcome:hover .close{display:block;}
			...
			.tz_content .t_right .r_table .r_table_list tr th{line-height:40px;background:#eee;}
	...
	<div class="tz_content">
		...
		<div class="t_header">
			...
			<div class="h_nav">
				<ul>
					...
					<li>
						<a href="${basePath }/admin/page/toPageManage">
							<i class="h_icon2"></i>
							<span>界面管理</span>
						</a>
					</li>
		...
		<div class="t_right">
			...
			<div class="r_location">
				<i></i>
				<p>您当前所在位置：首页 &gt; 后台中心</p>
				<div class="l_welcome animated fadeInDown">管理员：${admin.account }，欢迎来到followMusic音乐网站后台中心。<a href="javascript:void(0)" class="close" style="">x</a></div>
			</div>
			<!--end r_location-->
