	...
	<div id="login_div">
		...
		<div class="login_bt">
			<div class="login_logo">
				<img src="${basePath }/images/admin/login/login_logo.png" width="450" height="65" />
			</div>
		</div>
			...
			<div class="login_zi">
				...
				<div class="yanzheng">
					<div class="box">
						...
						<div class="yz_pic"><img src="${basePath }/checkcode"/></div>
					</div>
				</div>
				<div class="yz_change">
...
<script type="text/javascript">
	function tz_login(){
		...
		$.tzAjax.request({url:basePath+"/users/admin/login",callback:function(data){
			if(data.result=="success"){
				window.location.href = basePath+"/admin/page/toAdminIndex";
			}
