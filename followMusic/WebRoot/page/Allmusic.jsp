...
<html>
	<head>
		...
		<style type="text/css">
			...
			.allmusic .a_content .c_right .r_ul li i{margin-top:8px;display:inline-block;width:14px;height:16px;background:url('${basePath }/images/usersend_page/music_page.png');vertical-align:top;margin-left:10px;cursor:pointer;}
