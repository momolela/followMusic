		...
		<div class="u_info animated bounceInLeft">
			...
			<div class="mid">
				<div class="mid_info">
					...
					<form>
						<span>用户名</span><input id="username" class="username" type="text" name="username" value="${user.username }"><br>
						<span>性别 ( 只限填写男,女 )</span><input id="sex" class="sex" type="text" value="${user.sex }"><br>
					</form>
