...
<html>
	<head>
		...
		<style type="text/css">
			...
			.userInfo .u_info .mid .mid_emial form input{width:250px;height:36px;border-radius:5px;border:1px solid #e1e1e1;background:#fafafa;outline:none;font-size:16px;padding-left:10px;}
			.userInfo .u_info .mid .mid_emial form img{margin-right:10px;display:block;width:70px;height:36px;border-radius:5px;border:1px solid #e1e1e1;background:#fafafa;float:left;}
...
<jsp:include page="/commons/head.jsp"/>
	<div class="userInfo">
		<div class="u_info">
			...
			<div class="left_nav">
				<div class="n_name">
					<img src="${basePath }/${user.userpicurl }" width="75px" height="75px"/>
