...
<jsp:include  page="/commons/head.jsp"/>
	<div class="music_box">
		...
		<div class="box_face">
			<!-- left start -->
			<div class="left">
				<div class="l_logo" style="width:100%;height:150px;"><img src="${basePath }/images/music_box/music_box_logo.png"/></div>
				<div class="l_nav">
					<ul>
						...
						<li>
							<a class="n_upload" style="background:rgba(198,211,205,0.5);" href="${basePath }/page/UserMusic.jsp" target="_blank">上传喜欢的歌曲</a>
						</li>
					</ul>
				</div>
			</div>
		...
		<div class="font"><img src="${basePath }/images/music_box/font.png" width="300px" height="30px"/></div>
	</div>
<jsp:include page="/commons/bottom.jsp"/>
<script type="text/javascript" src="${basePath }/js/jquery.js"></script>
<script type="text/javascript" src="${basePath }/js/musicbox.js"></script>
