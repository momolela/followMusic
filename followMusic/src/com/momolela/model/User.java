...
public class User {
	...
	private Set<Song> usersend = new HashSet<Song>();
	...
	@ManyToMany
	@JoinTable(name = "usersend", joinColumns = @JoinColumn(name = "uid", referencedColumnName = "id"), inverseJoinColumns = @JoinColumn(name = "sid", referencedColumnName = "id"))
	public Set<Song> getUsersend() {
		return usersend;
	}

	public void setUsersend(Set<Song> usersend) {
